...
public class PopUpWindow: UIViewController {

    public let popUpWindowView = PopUpWindowView()
...
public class PopUpWindowView: UIView {
    ...
    init() {
        ...
        popupView.backgroundColor = UIColor.colorFromHex("#198754").withAlphaComponent(0.5)
